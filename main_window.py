...
"")
        ...
        self.reset_button.setGeometry(QtCore.QRect(40, 340, 20, 20))
        font = QtGui.QFont()
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("static/img/background/reset_icon.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.reset_button.setIcon(icon)
        self.reset_button.setObjectName("reset_button")
        self.groupBox = QtWidgets.QGroupBox(self.centralwidget)
        self.groupBox.setGeometry(QtCore.QRect(660, 10, 111, 131))
...
"}")
        ...
        self.label_profile1.setGeometry(QtCore.QRect(-100, -20, 321, 291))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(660, 180, 111, 131))
...
"}")
        ...
        self.label_profile2.setGeometry(QtCore.QRect(-70, -10, 241, 271))
        ...
        self.exit_button.setGeometry(QtCore.QRect(10, 340, 20, 20))
        font = QtGui.QFont()
        font.setFamily("Arial Narrow")
        font.setPointSize(16)
        font.setBold(False)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("static/img/background/cross.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.exit_button.setIcon(icon1)
        self.exit_button.setObjectName("exit_button")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(70, 340, 411, 20))
        font = QtGui.QFont()
        ...
        self.label_score1 = QtWidgets.QLabel(self.centralwidget)
        self.label_score1.setGeometry(QtCore.QRect(660, 140, 111, 20))
        font = QtGui.QFont()
        font.setFamily("8514oem")
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.label_score1.setStyleSheet("background-color: #716799;")
        self.label_score1.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_score1.setObjectName("label_score1")
        self.label_score2 = QtWidgets.QLabel(self.centralwidget)
        self.label_score2.setGeometry(QtCore.QRect(660, 310, 111, 20))
        font = QtGui.QFont()
        font.setFamily("8514oem")
        font.setPointSize(8)
        font.setBold(True)
        ...
        self.info_label.setStyleSheet("background-color: #716799;\n"
"border-raduis: 2px;\n"
"color: #fff352;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.info_label.setText(_translate("MainWindow", "YOU WIN!"))
