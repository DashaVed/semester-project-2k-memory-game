...
"}")
        ...
        self.label_profile1.setGeometry(QtCore.QRect(-90, -20, 321, 291))
        ...
        self.label_score1.setGeometry(QtCore.QRect(0, 130, 121, 20))
        font = QtGui.QFont()
        ...
        self.label_score1.setStyleSheet("background-color: #ffffff;")
...
"}")
        ...
        self.label_score2.setGeometry(QtCore.QRect(0, 130, 121, 20))
        font = QtGui.QFont()
        font.setFamily("Gill Sans MT")
        font.setPointSize(14)
        font.setBold(True)
        ...
        self.label_score2.setStyleSheet("background-color: #ffffff;")
